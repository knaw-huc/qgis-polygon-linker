...
class LayerSelector:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'LayerSelector_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Layer Selector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('LayerSelector', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/layer_selector/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Layer selector'),
            callback=self.run,
